...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline: TextStyle(fontSize: 20.0, color: _lightTextColor),
    display1: TextStyle(fontSize: 16.0, color: _lightTextColor),
    display2: TextStyle(fontSize: 14.0, color: Colors.grey),
    button: TextStyle(
        fontSize: 15.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    subhead: TextStyle(fontSize: 16.0, color: _lightTextColor),
    subtitle: TextStyle(fontSize: 16.0, color: _lightTextColor),
...
//text theme for dark theme
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    headline: TextStyle(fontSize: 20.0, color: _darkTextColor),
    display1: TextStyle(fontSize: 16.0, color: _darkTextColor),
    display2: TextStyle(fontSize: 14.0, color: Colors.grey),
    button: TextStyle(
        fontSize: 15.0, color: _darkTextColor, fontWeight: FontWeight.w600),
    subhead: TextStyle(fontSize: 16.0, color: _darkTextColor),
    subtitle: TextStyle(fontSize: 16.0, color: _darkTextColor),
